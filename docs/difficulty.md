...
language syntax involved.

## Foundation (12)

Use these to learn a language and practice basic control flow.
...
These introduce common interview patterns and data structures.
...
- [Fibonacci](../challenges/fibonacci/README.md)
- [Spiral Matrix](../challenges/spiral-matrix/README.md)

## Hard (0)

Hard challenges will be added after the supporting patterns have enough easy
and medium exercises. This avoids introducing difficulty without preparation.
